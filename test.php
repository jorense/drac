...
<div class="full-wrapper">
            ...
            <div class="row">
                <div class="col-md-9 col-xs-8">
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="index.html"><img src="images/diamond-rent-a-car-logo.png" class="img-responsive center-block"></a>
                    </div>
                ...
                <div class="col-md-3 col-xs-4">
                    <ul class="list-inline right-nav-item hidden-xs hidden-md">
                        <li>
                            <a href="#" class="book-now-link"> <p class="book-now">BOOK NOW </p></a></li>
                        <li>
    ...
    <img src="images/background-full-home.jpg" class="img-responsive">
