<?php
	...
	$car511 = "<div id='car-container'><img src='./car-image/toyota_wigo.jpg'><h1>TOYOTA WIGO</h1><div id='car-button'><div id='car'><h2>AUTOMATIC</h2><h3>Php 1,199/day</h3></div></div></div>";
